...
#guard Shape.toString (Shape.placeAbove ([] : Shape) top) == Shape.toString top
#guard Shape.toString (Shape.placeAbove bot ([] : Shape)) == Shape.toString bot
#guard Shape.toString (Shape.placeAbove bot top) == Shape.toString (bot ++ top)
