...
-- 0 層: nil
#guard Shape.toString (Shape.paint [] Color.red) == ""

-- 1 層: そのレイヤを着色
#guard (Shape.paint [L_mixed] Color.blue).length == 1
#guard Shape.toString (Shape.paint [L_mixed] Color.blue) == (L_mixed.paint Color.blue).toString
...
-- 連続着色: 最後の色で上書き
#guard Shape.toString (Shape.paint (Shape.paint [L_bottom, L_top] Color.red) Color.blue) ==
  Shape.toString ([L_bottom, L_top.paint Color.blue] : Shape)
