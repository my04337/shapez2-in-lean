...
#guard Shape.toString (Shape.eastHalf [] : Shape) == ""
#guard Shape.toString (Shape.westHalf [] : Shape) == ""
...
#guard Shape.toString (Shape.cut s1).1 == Shape.toString (Shape.eastHalf s1)
#guard Shape.toString (Shape.cut s1).2 == Shape.toString (Shape.westHalf s1)
#guard Shape.toString (Shape.halfDestroy s1) == Shape.toString (Shape.eastHalf s1)
