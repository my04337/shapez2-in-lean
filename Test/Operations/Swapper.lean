...
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).1 (0, Direction.ne) == L_a Direction.ne
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).1 (0, Direction.se) == L_a Direction.se
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).1 (0, Direction.sw) == L_b Direction.sw
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).1 (0, Direction.nw) == L_b Direction.nw
-- 出力 .2 の各方角:  NE/SE は s_b, SW/NW は s_a
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).2 (0, Direction.ne) == L_b Direction.ne
#guard QuarterPos.getQuarter (Shape.swap s_a s_b).2 (0, Direction.sw) == L_a Direction.sw
