...
| [ライブラリ・ツール一覧](library-reference.md) | S2IL で導入済みの Lean 関連ライブラリ・ツールの利用状況と追従方針 |
...
| ドキュメント | 対応スキル | 概要 |
|---|---|---|
| [Lean REPL 詳細ガイド](../../.github/skills/lean-tooling/references/repl-guide.md) | `lean-tooling` | 3 モード・pickle 戦略・ユースケース集 |
| [Mathlib / Batteries 補題検索ガイド](../../.github/skills/lean-proof-methods/references/mathlib-search-guide.md) | `lean-proof-methods` | `exact?` / `apply?` / `#leansearch` / `#loogle` の使い分けと検索戦略マップ |
