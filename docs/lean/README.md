...
| ドキュメント | 概要 |
|---|---|
| [Functional Programming in Lean — エージェント向け包括ガイド](fp-in-lean-guide.md) | FP in Lean 書籍の主要概念をエージェント向けに要約したガイド |
| [Theorem Proving in Lean 4 — エージェント向け定理証明ガイド](theorem-proving-guide.md) | TPIL4 書籍の定理証明概念をエージェント向けに要約したガイド |
