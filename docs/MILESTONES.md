...
| 1-1-2 | **Color** の列挙型定義 (`Red`, `Green`, `Blue`, `Yellow`, `Cyan`, `Magenta`, `White`, `Uncolored`) | ⬜ 未着手 |
| 1-1-3 | **Quarter** (象限) の型定義 (Part Code × Color の組、および空の象限) | ⬜ 未着手 |
...
| # | タスク | 状態 |
|---|---|---|
| 1-2-5 | **Rotator** (回転機): 時計回り 90° 回転関数 | ⬜ 未着手 |
| 1-2-6 | **Reverse Rotator** (逆回転機): 反時計回り 90° 回転関数 | ⬜ 未着手 |
| 1-2-7 | **180° Rotator** (180 度回転機): 180° 回転関数 | ⬜ 未着手 |
| 1-2-8 | 回転の合成・逆元に関する定理 (例: 4 回回転 = 恒等) | ⬜ 未着手 |
...
| 1-2-10 | 積み重ね時の落下ルールの形式化 (空象限・欠落パーツの落下挙動) | ⬜ 未着手 |
