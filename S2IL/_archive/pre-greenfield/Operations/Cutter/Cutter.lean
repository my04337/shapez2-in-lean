...
private theorem settleAfterCut_rotate180 (s : Shape) (_h : s.layerCount ≤ 5) :
    ...
    · -- isEmpty = true → gravity
      exact gravity_rotate180_comm s
    · -- isEmpty = false → gravity
      rw [gravity_rotate180_comm _ , shatterOnFall_rotate180_comm]
