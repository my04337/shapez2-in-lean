...
```powershell
.github/skills/lean-tooling/scripts/build.ps1          # Windows
.github/skills/lean-tooling/scripts/build.sh            # macOS / Linux
```
...
[SORRY] S2IL/Operations/Gravity/Behavior.lean:5019:16: declaration uses `sorry`
=== END DIAGNOSTICS ===
```
...
```json
{"file":"S2IL/Operations/Gravity/Behavior.lean","line":5019,"col":16,"severity":"warning","message":"declaration uses `sorry`","isSorry":true}
```
...
```powershell
$output = .github/skills/lean-tooling/scripts/build.ps1
...
```powershell
lake env lean S2IL/Operations/Gravity.lean 2>&1 | Select-String "error|sorry"
```
...
詳細な診断分析・トリアージは **lean-diagnostics** 参照を参照。
